...
public class Principal {
   ...
   public static void main(String[] args) {
        ...
        int opcion= 0;double elemento= 0;
        Pila pil= new Pila();
        do
        {
            try
            {
                ...
                +"6.- Vaciar la pila \n"
                +"7.- Salir \n"
                +"Elige tu opción", "Menu de opciones",JOptionPane.INFORMATION_MESSAGE));
                
        switch(opcion){
                case 1:
                elemento=Double.parseDouble(JOptionPane.showInputDialog(null,
                ...
                if(!pil.estaVacia())
                {
                pil.vaciarPila();JOptionPane.showMessageDialog(null,"La pila se ha vaciado",
